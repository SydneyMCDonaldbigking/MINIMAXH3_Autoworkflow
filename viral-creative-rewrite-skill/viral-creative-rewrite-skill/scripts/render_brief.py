...
from services import _print_compact_decision_brief, _ui_language, normalize_prepared_for_generation


def print_compact_brief(prepared: PreparedRewrite) -> None:
    prepared = normalize_prepared_for_generation(prepared)
    _print_compact_decision_brief(prepared, language=_ui_language(prepared.request))
