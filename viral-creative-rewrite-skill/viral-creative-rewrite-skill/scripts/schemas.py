...
class RewriteRequest(BaseModel):
    ...
    output_resolution: str = "1080x1920_native"
    generate_audio: bool = False
    h3_server: str = "http://127.0.0.1:8189"
    h3_reference_images: List[str] = Field(default_factory=list)
    h3_sequence_id: str = ""
    h3_run_id: str = ""
    h3_seed_base: int = 26081800
    h3_no_concat: bool = True
    h3_dry_run: bool = False
...
class RewriteVideoResponse(BaseModel):
    ...
    provider: str = "minimax_h3"
    h3_run_id: Optional[str] = None
    h3_manifest_path: Optional[str] = None
    h3_sequence_json_path: Optional[str] = None
    h3_clip_paths: List[str] = Field(default_factory=list)
