...
summary:
reference generation. A five-second vertical premium cooking commercial, clip 03 of three, the closing beat for Japanese pan-seared beef steak. It continues from <Picture 1> and carries the dish from the vessel to the table, landing on the hero state of <Picture 4>. The product job is that the ingredient of <Picture 5> stays identifiable in its finished form. The clip ends on a still composed hero frame that can be held or trimmed in the edit.
...
[Shot 1] Locked-off close food angle, 50mm feel, continuing directly from <Picture 1>. The vessel of <Picture 3> sits at the left of frame, the serving dish of <Picture 4> waiting at the right on the table. The hands of <Subject 1> enter from the top of frame with tongs, lift the rested steak onto a board, and a knife slices it across the grain into thick pieces that fan open to show an even pink centre. The camera does not move at any point in this shot. The shot ends on the filled dish with individual pieces clearly visible.
...
overall_soundscape:
A quiet room. In the first shot, a knife cutting cleanly through meat against a board. In the second shot, flaked salt falling. In the third shot, chopsticks lifting a slice, and a bowl settling on wood. No speech.

non_diegetic_music:
A restrained solo bed: a single piano or cello, slow, with long silences between phrases, precise and solitary rather than warm. It lifts as the garnish lands and settles into a complete final cadence as the piece is lifted.
