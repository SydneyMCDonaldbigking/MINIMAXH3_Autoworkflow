...
PURPOSE: character and kitchen style reference for MiniMax H3 Sake Chazuke, salmon ochazuke.

SCENE: a small Japanese home kitchen with pale wood and a single gas ring, a tokoname teapot on the counter, neutral daylight from a window on the left, warm only in the shadows.

SUBJECT: a Japanese cook in her thirties in a plain indigo apron, unhurried and precise, standing at a prep counter. The raw ingredient is clearly presented on the counter: raw salmon fillets on crushed ice, flesh deep orange with clean white fat lines running through it and the skin silver at one edge, no packaging anywhere in frame. The ingredient sits directly on a plate, board or bowl. There is no retail packaging anywhere in the room: no trays with labels, no boxes, no punnets, no bags, no cling film, nothing with a sticker or a barcode on it, not even at the edge of frame or out of focus in the background.
...
NEGATIVE: subtitles, title cards, watermarks, floating logo, any printed card, any brand text, invented lettering, fake app UI, distorted face, extra fingers, warped cookware, messy kitchen, no lettering, logos or model names on burners, stoves, pots, pans, appliances, packaging or containers, no readable text anywhere in frame, raw sashimi salmon, poached or steamed salmon, breadcrumbs or batter, tea poured before the salmon is on, a soup bowl full of broth, umeboshi mashed or chopped, plastic packaging, sealed tray, product label, printed nutrition panel, barcode, brand names or lettering on appliances, pots, burners or packaging anywhere in the scene, any readable text of any kind in frame.
